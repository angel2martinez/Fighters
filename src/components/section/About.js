    ...
    return (
        <Section>
            <Container>
                ...
                <Box>
                <Title>
                Welcome To The SuperRunMetaverseNFT.
                </Title>
                <SubTitle>
                The SuperRunMetaverseNFT is a private collection of NFTs—unique digital collectibles. The SuperRunMetaverseNFT are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS.
                </SubTitle>
                <SubTextLight>
